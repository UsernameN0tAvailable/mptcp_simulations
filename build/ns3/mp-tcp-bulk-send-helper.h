...
/*
 * Copyright (c) 2014 University of Sussex
...
#ifndef MP_TCP_BULK_SEND_HELPER_H
#define MP_TCP_BULK_SEND_HELPER_H
...
public:
   ...
   *        to.
   */
  MpTcpBulkSendHelper (std::string protocol, Address address);
