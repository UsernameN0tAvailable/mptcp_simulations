...
TcpSocketBase::TcpSocketBase(void) :
    ...
    m_highTxMark(0), m_rxBuffer(0), m_txBuffer(0), m_state(CLOSED), m_errno(ERROR_NOTERROR), m_closeNotified(false), m_closeOnEmpty(
        false), m_shutdownSend(false), m_shutdownRecv(false), m_connected(false), m_segmentSize(1000), // force segment size
...
TcpSocketBase::GenerateDetail(void)
{
  ...
  detail << "TcpNewReno" << " C:" << lCapacity / 1000 << "Kbps  RTT:" << RTT_TCP
      << "Ms  D:" << totalBytes_TCP / 1000 << "Kb  dtQ(" << dtq_TCP << ")  MSS:" << m_segmentSize << "B";
  return detail.str();
}
